...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView EnableExp="" ID="form" runat="server" DataSourceID="ds" DataMember="StockItems" Width="99%" Height="150px" AllowAutoHide="false">
        <Template>
        ...
        <ContentLayout AutoSizeControls="False"></ContentLayout>
    </px:PXFormView>
</asp:Content>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="InventoryLocations">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="QtyHand" Width="70"></px:PXGridColumn>
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
